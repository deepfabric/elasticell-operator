...
func (h *ha) realCCGetFn(ns, ccName string) (*v1alpha1.CellCluster, error) {
	return h.cli.DeepfabricV1alpha1().CellClusters(ns).Get(ccName, metav1.GetOptions{})
}
...
func getReplicasFrom(cc *v1alpha1.CellCluster, component string) int32 {
	if component == v1alpha1.PDMemberType.String() {
		return cc.Spec.PD.Replicas
	}

	return cc.Spec.Store.Replicas
}

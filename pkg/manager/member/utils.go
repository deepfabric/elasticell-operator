...
const (
	...
	LastAppliedConfigAnnotation = "deepfabric.com/last-applied-configuration"
...
func storePodName(ccName string, ordinal int32) string {
	return fmt.Sprintf("%s-%d", controller.StoreMemberName(ccName), ordinal)
}

func pdPodName(ccName string, ordinal int32) string {
	return fmt.Sprintf("%s-%d", controller.PDMemberName(ccName), ordinal)
}

func proxyPodName(ccName string, ordinal int32) string {
	return fmt.Sprintf("%s-%d", controller.ProxyMemberName(ccName), ordinal)
}

...
var (
	...
	controllerKind = v1alpha1.SchemeGroupVersion.WithKind("CellCluster")
	// DefaultStorageClassName is the default storageClassName
	DefaultStorageClassName string
	// ClusterScoped controls whether operator should manage kubernetes cluster wide Cell clusters
	ClusterScoped bool
)
...
// GetOwnerRef returns CellCluster's OwnerReference
func GetOwnerRef(cc *v1alpha1.CellCluster) metav1.OwnerReference {
	controller := true

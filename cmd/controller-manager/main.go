...
import (
	...
	"github.com/deepfabric/elasticell-operator/pkg/controller/cellcluster"
...
func init() {
	...
	flag.BoolVar(&controller.ClusterScoped, "cluster-scoped", true, "Whether cell-operator should manage kubernetes cluster wide Cell Clusters")
...
func main() {
	...
	// leader election for multiple cell-cloud-manager
